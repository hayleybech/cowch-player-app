                ...
                <View>
                    ...
                    <View className="flex gap-2 mb-16">
                        <Button onPress={() => move('up')}
                                disabled={!connRef.current || isPaused || currentDirection === 'up' || currentDirection === 'down'}
                                className="h-32">
                            Up
                        </Button>
                        <View className="flex gap-2 flex-row flex-nowrap justify-between">
                            <View className="grow">
                                ...
                                <Button onPress={() => move('left')}
                                        disabled={!connRef.current || isPaused || currentDirection === 'left' || currentDirection === 'right'}
                                        className="h-32">
                                    Left
                                </Button>
                            </View>
